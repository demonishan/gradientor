  ...
  return (
    <Box component="footer" aria-label="Gradientor app footer" sx={{ p: 2, pb: 4 }}>
      <Typography variant="body2" sx={{ color: theme.palette.text.secondary, textAlign: `center` }}>
        ...
        <BlurOnRoundedIcon color="primary" fontSize="small" sx={{ mx: `0.25em`, verticalAlign: `middle` }} aria-label="divider icon" />
        &copy; {new Date().getFullYear()}
        <BlurOnRoundedIcon color="primary" fontSize="small" sx={{ mx: `0.25em`, verticalAlign: `middle` }} aria-label="divider icon" />
        Made with
        <FavoriteTwoToneIcon fontSize="small" sx={{ mx: `0.25em`, verticalAlign: `middle`, color: `error.main` }} aria-label="favorite icon" />
        by
        <a target="_blank" rel="noopener noreferrer" href="https://www.666de666.com" aria-label="Visit Ishan Samanta's website" style={{ marginLeft: `0.25em`, color: theme.palette.text.secondary }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" style={{ fill: theme.palette.text.secondary, width: `1.5em`, height: `1.5em`, marginRight: `0.25em`, verticalAlign: `middle` }} role="img" aria-labelledby="footer-logo-title">
